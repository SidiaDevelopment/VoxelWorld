...
public class Chunk : MonoBehaviour
{
    ...
    public void UpdateVoxel(int x, int y, int z, ref GameObject voxel)
    {
        ...
        voxel.transform.Find("Back").gameObject.SetActive(!(x < chunkSize - 1 && voxelTypes[x + 1, y, z] == 1));
        voxel.transform.Find("Front").gameObject.SetActive(!(x > 0 && voxelTypes[x - 1, y, z] == 1));
        voxel.transform.Find("Left").gameObject.SetActive(!(z < chunkSize - 1 && voxelTypes[x, y, z + 1] == 1));
        voxel.transform.Find("Right").gameObject.SetActive(!(z > 0 && voxelTypes[x, y, z - 1] == 1));
    }
